...
http://travis-ci.org/assaf/rack-oauth2-server.png
...
After this, remember to include the server admin module in your initializer (environemnt.rb or application.rb), because this is an optional
feature:
